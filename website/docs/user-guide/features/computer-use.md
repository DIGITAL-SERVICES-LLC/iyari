...
IYARI intentionally keeps its skill (`skills/computer-use/SKILL.md`)
...
- **IYARI spawns its own `cua-driver mcp` child over stdio** — it does
...
- **IYARI-side skill** — `skills/computer-use/SKILL.md` — teaches the
