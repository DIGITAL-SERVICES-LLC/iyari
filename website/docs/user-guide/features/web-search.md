...
The summary keeps quotes, code blocks, and key facts in their original formatting — it's a content compressor, not a paraphraser. If summarization fails or times out, IYARI falls back to the first ~5 000 chars of raw content rather than a useless error.
